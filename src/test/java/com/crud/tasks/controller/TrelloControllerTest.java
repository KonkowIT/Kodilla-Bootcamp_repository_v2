...
@WebMvcTest(TrelloController.class) // automatyczna konfiguracja MVC
public class TrelloControllerTest {

    @Autowired
    private MockMvc mockMvc; // klasa do tworzenia testów kontrolerów
    ...
    public void shouldFetchEmptyTrelloBoards() throws Exception {
        ...
        // when & then
            // dlatego, że MockMvc pozwala na wykonanie wywołania i asercji
        mockMvc.perform(get("/v1/tello/getTrelloBoards").contentType(MediaType.APPLICATION_JSON))
